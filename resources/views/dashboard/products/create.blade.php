                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-8">
                                        <form action="#!">
                                            ...
                                            <div class="mb-3">
                                                <label for="productCategories" class="form-label">Categories
                                                    <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xxl-8">
                                        <div class="row gy-3">
                                            ...
                                            <div class="col-lg-4">
                                                <div>
                                                    <label for="productStocks" class="form-label">Stocks
                                                        <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="productStocks"
